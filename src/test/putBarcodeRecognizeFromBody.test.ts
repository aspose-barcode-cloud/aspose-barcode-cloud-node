...
describe('putBarcodeRecognizeFromBody', function () {
    this.timeout(60000);
    ...
    it('should recognize uploaded image', async function () {
        ...
        const recognized = await api.putBarcodeRecognizeFromBody(filename, readerParams, undefined, undefined, tempFolderPath);
